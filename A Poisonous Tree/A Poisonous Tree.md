...
### 动态规划 （入门）Dynamic Programming (Elementary)

#### 线性动态规划 Linear Dynamic Progamming

#### 路径动态规划 Pahyway Dynamic Programming
...
### 指针的定义与应用 Definition and Application of Pointer
...
### 图论入门 Graph Theory Introduction
